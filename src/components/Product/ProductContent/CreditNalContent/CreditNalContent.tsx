import style from './creditnalcontent.module.scss'
...
const CreditNalContent = () => {
	return (
		<section className={style.contentContainer}>
			<h2 className={style.title}>О Потребительском кредите</h2>
			...
			<div className={style.creditContainers}>
				<div className={style.creditContainer}>
					...
					<div className={style.creditDesc}>
						<li>до 5 млн. ₽ сумма кредита «на руки»</li>
						<li>от 1 до 5 лет срок кредита</li>
						<li>от 38% ставки по кредиту</li>
					</div>
				</div>
				<div className={style.creditContainer}>
					<img src={icon3} alt='...' />
...
export default CreditNalContent
