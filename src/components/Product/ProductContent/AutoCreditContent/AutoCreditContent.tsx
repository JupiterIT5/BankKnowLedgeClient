import style from './autocreditcontent.module.scss'
...
const AutoCreditContent = () => {
	return (
		<section className={style.contentContainer}>
			<h2 className={style.title}>О Автокредите</h2>
			...
			<div className={style.creditContainers}>
				<div className={style.creditContainer}>
					...
					<div className={style.creditDesc}>
						<li>до 8 млн. ₽ сумма кредита «на руки»</li>
						<li>от 2 до 5 лет срок кредита</li>
						<li>от 37,2% ставки по кредиту</li>
					</div>
				</div>
				<div className={style.creditContainer}>
					<img src={icon3} alt='...' />
...
export default AutoCreditContent
